function [StrainImage,SigmaImage,opts,edgeWidthImage,edgeWidthStdImage] = makeStrainImage(OB,Proj,opts,BraggOpts,d0Tr)
...
%           This structure is generated using the ImageOptions function.
%       - BraggOpts is a structure containing the required options for edge
%           fitting. This structure can be generated by using the function
%           BraggOptions.
%
%   Outputs:
...
%
%See also Braggoptions, ImageOptions
